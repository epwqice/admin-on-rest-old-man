...
var createMenu = function createMenu(resources, translate, onMenuTap, basePath) {
    ...
    resources.filter(function (r) {
        ...
        childNode.push(_react2.default.createElement(_MenuItem2.default, {
            ...
            containerElement: _react2.default.createElement(_reactRouter.Link, { to: "/" + currentPath + "/" + resource.name }),
